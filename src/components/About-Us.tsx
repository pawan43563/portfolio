...
const AboutUs = () => {
    ...
    <p className="text-wrap">I am a full-stack developer with 3.4 years of experience in the tech industry, specializing in delivering innovative, user-centric solutions. At Contentstack, I’ve built custom plugins for search personalization and translation, making these features more accessible for users.
